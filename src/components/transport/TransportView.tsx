                ...
                <div key={idx} className="bg-white dark:bg-[#111B2E] p-4 rounded-2xl border border-gray-100 dark:border-blue-900/30 shadow-sm transition cursor-pointer space-y-3">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <button
                      ...
                      className="p-2 rounded-xl bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900/60 transition-all duration-300 cursor-pointer shrink-0"
