...
export const RestaurantDashboardView: React.FC = () => {
  ...
  const fetchRestaurantOwnerRestaurant = async () => {
    try {
      ...
      if (targetRestaurant) {
        ...
        setEditPhotos(targetRestaurant.photos || (targetRestaurant.photoUrl ? [targetRestaurant.photoUrl] : []));
  ...
  const handleSaveRestaurantProfile = async (e: React.FormEvent) => {
    ...
    try {
      const finalPhotoUrl = editPhotos[0] || editPhotoUrl || restaurant.photoUrl || '';
      const updatePayload = {
      ...
      <div className="p-4 space-y-4">
        ...
        {activeTab === 'profile' && (
          <form onSubmit={handleSaveRestaurantProfile} className="space-y-4">
            ...
            <div className="bg-white dark:bg-[#0F172A] border border-[#E8E4DA] dark:border-white/10 rounded-3xl p-4 shadow-xs space-y-4">
              <div className="flex items-center gap-2">
              ...
              <p className="text-[11px] text-gray-500 dark:text-gray-400 leading-normal">
                Add up to 4 photos of your cafe/restaurant. The first photo will be your main thumbnail in search results. You can prioritize them below.
              </p>
