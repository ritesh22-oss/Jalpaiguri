...
export const BottomNav: React.FC = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white/95 dark:bg-[#0F172A]/95 backdrop-blur-md border-t border-gray-100 dark:border-white/10 px-2 py-1 pb-safe flex items-center justify-around max-w-md mx-auto shadow-[0_-4px_25px_rgba(0,0,0,0.06)] transition-colors">
      {/* 1. Home */}
      <button
        id="nav-home"
